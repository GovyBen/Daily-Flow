...
object PrefsConstants {
    ...
    const val CALENDAR_VIEW_MODE_KEY = "calendar_view_mode_v2"
    ...
    const val DEEPSEEK_URL_KEY = "deepseek_url"
    const val QWEN_MODEL_KEY = "qwen_model"
    const val QWEN_KEY = "qwen_key"
    const val QWEN_URL_KEY = "qwen_url"
    const val KIMI_MODEL_KEY = "kimi_model"
    const val KIMI_KEY = "kimi_key"
    const val KIMI_URL_KEY = "kimi_url"
